...
export const ThemeToggle: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <button
      ...
      className={cn(
        'inline-grid size-9 place-items-center rounded-full border border-border bg-background text-foreground transition-colors hover:bg-secondary hover:text-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
        className,
      )}
    >
