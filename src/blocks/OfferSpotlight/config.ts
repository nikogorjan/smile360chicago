...
export const OfferSpotlight: Block = {
  ...
  fields: [
    { name: 'eyebrow', type: 'text', defaultValue: 'New patient special' },
    {
      ...
      admin: { description: 'The offer, e.g. “$99 exam, X-rays & cleaning”. Style a phrase for emphasis.' },
    },
    { name: 'subline', type: 'textarea', admin: { description: 'One line on who it’s for / what’s included.' } },
    { name: 'seal', type: 'text', defaultValue: 'New patients only', admin: { description: 'Short text inside the gold seal.' } },
    { name: 'finePrint', type: 'text', admin: { description: 'Small print — restrictions, expiry.' } },
    { name: 'sealIcon', type: 'text', defaultValue: 'BadgePercent', admin: { description: 'lucide icon shown in the seal.' } },
